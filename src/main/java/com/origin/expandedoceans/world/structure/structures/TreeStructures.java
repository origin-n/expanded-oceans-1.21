package com.origin.expandedoceans.world.structure.structures;
...
public class TreeStructures extends Structure {

    // A custom codec that changes the size limit for our code_structure_sky_fan.json's config to not be capped at 7.
    // With this, we can have a structure with a size limit up to 30 if we want to have extremely long branches of pieces in the structure.
    public static final MapCodec<TreeStructures> CODEC = RecordCodecBuilder.mapCodec(instance ->
            instance.group(TreeStructures.configCodecBuilder(instance),
            ...
            ).apply(instance, TreeStructures::new));
    ...
    public TreeStructures(Structure.Config config,
    ...
    private static boolean extraSpawningChecks(Structure.Context context) {
        ...
        int landHeight = context.chunkGenerator().getHeightInGround(
                chunkpos.getStartX(),
                chunkpos.getStartZ(),
        ...
        int oceanFloorHeight = context.chunkGenerator().getHeightInGround(
                chunkpos.getStartX(),
                chunkpos.getStartZ(),
        ...
        return landHeight <= seaLevel && seaLevel - oceanFloorHeight >= 7;
    }
    ...
    public Optional<Structure.StructurePosition> getStructurePosition(Structure.Context context) {
        ...
        if (!TreeStructures.extraSpawningChecks(context)) {
    ...
    public StructureType<?> getType() {
        return ModStructures.TREE_STRUCTURES; // Helps the game know how to turn this structure back to json to save to chunks
    }
}
